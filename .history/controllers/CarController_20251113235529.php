...
class CarController
{
    ...
    private function loadData()
    {
        ...
        $this->photoPath = uploadPhoto('photo', 'carPhoto'); // если файл есть — путь, иначе false/null
    }
    ...
    private function validate($isUpdate = false)
    {
        ...
        // фото обязательно только при create
        if (!$isUpdate && !$this->photoPath) {
            $errors[] = 'Enter photo';
        }
    ...
    $photo = $this->photoPath ?: $car['photo']; // ✅ правильно
